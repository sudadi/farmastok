...
if($_SERVER['REQUEST_METHOD'] === "POST"){
	...
	$kdtrans=$_SESSION['transobatin'];
            ...
            $sql = "SELECT max(kdtrans) AS last FROM tobatin";
            $result=$db->query($sql);
            if ($result){
        ...
        if($kdtrans!='' || $kdsupp!='' || $nmsupp!='' || $kdobat!='' || $nmobat!='' || $qty<1){
            ...
            if($edit != '') {
                ...
                $sql = "INSERT INTO `tobatin` (`kdtrans`, `kdsupp`, `tgltrans`, `kdobat`, `qty`) "
                        . "values ('$kdtrans', '$kdsupp', CURRENT_DATE, '$kdobat', '$qty')";
                $db->query($sql);
            }
                          ...
                          <section class="content invoice">
                            <div class="row invoice-info">
                             ...
                             <div class="table-responsive">
                                ...
                                <tbody>
                                    <?php
                                    $sql="SELECT tobatin.*, tsupp.nmsupp, tobat.nmobat "
                                            . "FROM tobatin "
                                            . "INNER JOIN tobat on tobatin.kdobat=tobat.kdobat "
                                            . "INNER JOIN tsupp ON tobatin.kdsupp=tsupp.kdsupp "

        ...
        <div class="">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
            	<div class="x_title">
                  <h2>Laporan Pengeluaran Obat</h2>
                  <div class="clearfix"></div>
                </div>
                <div class="x_content">
                <br />
                    <form action="ajaxlapout.php" method="post" class="form-horizontal form-label-left" data-obatout>
                        <div class="form-group">
                            <label for="bln" class="control-label col-sm-2">Bulan</label>
                            <div class="col-sm-3">
                            ...
                            <label for="tahun" class="control-label col-sm-1">Tahun</label>
                            <div class="col-sm-2">
                                <select name="tahun" id="tahun" class="form-control input-sm">
                                    <option selected="selected">Tahun</option>
                                    <?php 
                                        $sql="select year(tgltrans) as tahun from tobatout group by tahun";
                                        $result = $db->query($sql);
                                        if ($result){
